          ...
          <div class="card-body p-0">
              ...
              <div class="col-lg-8">
                <div class="p-5">
                  ...
                  <form action="login_proses.php" method="post" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-primary btn-user btn-block" name="login" value="login">Login</button>

                    <br>
                    <button class="btn btn-outline-danger" name="daftar" value="daftar">Create new</button>
                    <hr>
            ...
            if (isset($_GET['pesan'])) {
              ...
              if ($pesan == "gagal") {
                ...
                echo "<p><center>Akun Belum Di Konfirmasi Admin</center></p>";
                echo   "</div>";
                echo "</div>";
