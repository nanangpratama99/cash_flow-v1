          ...
          if(isset($_GET['hapus'])){
             ...
             echo "</div>";
                           ...
                           if(mysqli_num_rows($brg) > 0){
                              ...
                              $brg=mysqli_query($conn, "select * from konfir_honor limit $start, $hal");
                            }
                           ...
                           if(mysqli_num_rows($brg)){
                             ...
                             <tbody>
                               <tr>
                                 ...
                                 <td>&nbsp;<a href="konfirm_honorp.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Konfirm</button></a> &nbsp; <a href="hapus_honorp.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a></td>
