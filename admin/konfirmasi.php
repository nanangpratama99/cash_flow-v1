        ...
        <div class="container-fluid">
             ...
             <h6 class="m-0 font-weight-bold text-primary">Data Anggota:</h6>
                          ...
                          <div class="card-body">
                            ...
                            $jumlah_cos=mysqli_query($conn,"SELECT COUNT(*) as id from konfirmasi");
          ...
          if(isset($_GET['hapus'])){
             ...
             echo "</div>";
                             ...
                             if(isset($_GET['cari'])){
                              ...
                              $brg=mysqli_query($conn, "select * from konfirmasi where id like '%".$cari."%' or nama like '%".$cari."%' ");
                           ...
                           if(mysqli_num_rows($brg) > 0){
                              ...
                              $brg=mysqli_query($conn, "select * from konfirmasi limit $start, $hal");
                            }
                           ...
                           if(mysqli_num_rows($brg)){
                             ...
                             <tbody>
                               <tr>
                                 ...
                                 <td>&nbsp;<a href="konfirm_anggota.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Konfirm</button></a> &nbsp; <a href="hapus_anggota.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a></td>
