      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <?php
            ...
            $det=mysqli_query($conn, "select * from konfir_honor where id='$id_brg'");
        ...
        <P><b>NIDN:</b></p>
         <input class="form-control" type="text" name='nidn' placeholder="NIDN" readonly  value="<?php echo $d['nidn']; ?>" required>

          <P><b>Nama Lengkap:</b></p>
          <input class="form-control" type="text" name='nama' placeholder="Nama Lengkap" readonly value="<?php echo $d['nama']; ?>" required>

          <P><b>Honor:</b></p>
          <input class="form-control" type="text" name='gaji' placeholder="Honor" readonly value="<?php echo $d['gaji']; ?>" required>
        ...
        <?php
          ...
          if(isset($_POST['edit'])){
           ...
           $hehe = "INSERT INTO honor (nama,nidn,gaji) VALUE ('$nama','$nidn','$gaji')";
           $edit = mysqli_query($conn, $hehe);
            ...
            if($edit){
             ...
             if($delete){
               ...
               echo "<p><center>Konfirmasi Honor Sukses</center></p>";
               echo   "</div>";
               echo "</div>";
             }
                            ...
                            echo "<div class='col-md-10 col-sm-12 col-xs-12 ml-5'>";
                               echo "<div class='alert alert-danger mt-4 ml-5' role='alert'>";
                              echo "<p><center>Konfirmasi Honor Gagal</center></p>";
                               echo   "</div>";
                               echo "</div>";
