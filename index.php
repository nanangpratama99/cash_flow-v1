...
include 'config/koneksi.php';
  ...
  $total=mysqli_fetch_array($Jumlah_kas);
    ...
    $Jumlah_honor=mysqli_query($conn, "select sum(gaji) as honor from honor");
    $totalh=mysqli_fetch_array($Jumlah_honor);

    $jumlah_anggota=mysqli_query($conn,"SELECT COUNT(*) as id from admin");
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Honor</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo "Rp.".number_format($totalh['honor']); ?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-credit-card fa-2x text-gray-300"></i>
                    </div>
