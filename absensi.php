          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    ...
                    <select class="form-control" name='nama' required>
                      ...
                      <?php
                      $brg = mysqli_query($conn, "select * from admin");
                  ...
                  <div class="col-sm-4">
                    <label>Tanggal:</label>
                    <input class="form-control form-control-sm" type="text" aria-label=".form-control-sm example" name='tanggal' readonly value=<?php echo  date("Y/m/d"); ?> required>
                  </div>

                  <div class="col-sm-4">
                    <label>Jam:</label>
                    <?php date_default_timezone_set("Asia/Jakarta"); ?>
                    <input class="form-control form-control-sm" type="text" aria-label=".form-control-sm example" name='jam' readonly value=<?php echo  date("G:i:s"); ?> required>
                  </div>
              ...
              if (isset($_POST['kirim'])) {
                ...
                $hehe = "INSERT INTO absen_dosen (nama,tanggal,jam) VALUE ('$nama','$tanggal','$jam' )";
                $edit = mysqli_query($conn, $hehe);

                if ($edit) {
                  echo "<div class='col-md-10 col-sm-12 col-xs-12'>";
                  echo "<div class='alert alert-primary mt-4 ml-5' role='alert'>";
                  echo "<p><center>Absen Sudah Masuk</center></p>";
                  echo   "</div>";
                  echo "</div>";
                } else {
                  echo "<div class='col-md-10 col-sm-12 col-xs-12'>";
                  echo "<div class='alert alert-danger mt-4 ml-5' role='alert'>";
                  echo "<p><center>Absen Gagal Masuk</center></p>";
                  echo   "</div>";
                  echo "</div>";
                }
              }
